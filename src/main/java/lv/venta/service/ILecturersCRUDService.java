...
public interface ILecturersCRUDService {
	...
	public abstract void createLecturer(String username, String name, String surname, String degree) throws Exception;

	public abstract Lecturers retrieveLecturerById(long id) throws Exception;

	public abstract void updateLecturerById(long id,String username, String name, String surname, String degree) throws Exception;
