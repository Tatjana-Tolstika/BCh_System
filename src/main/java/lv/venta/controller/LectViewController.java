...
public class LectViewController {
	...
	private static final String REDIRECT_LINK = "redirect:/professor/courses/";
	private static final String TEST_FOR_LINK = "/tests";
	private static final String TASKS_FOR_LINK = "/tasks";
	//-------------AllCourses-------------------
	...
	public String postConstrollerAddNewCourseTest(@PathVariable(name ="courseId") long courseId, CourseTests courseTest, BindingResult result, Model model) {
	    try {
	        ...
	        return REDIRECT_LINK + courseId + TEST_FOR_LINK;
	    } catch(Exception e) {
	        model.addAttribute("package", e.getMessage());
	        return "show-error";
	    }
	...
	public String postControllerAddNewTaskForTest(@PathVariable(name ="courseId") long courseId,@PathVariable(name = "testId") long testId, TestTask testTask, BindingResult result, Model model) {
	    try {
	        ...
	        return REDIRECT_LINK + courseId + "/tests/"+ testId + TASKS_FOR_LINK;
	    } catch(Exception e) {
	        model.addAttribute("package", e.getMessage());
	        return "show-error";
	    }
	...
	public String postControllerStudentResultUpdateByTask(
	    ...
	    try {
	        ...
	        return REDIRECT_LINK + courseId
	                + TEST_FOR_LINK + "/" + testId
	                + "/students/" + studentId
	                + "/results";
	...
	public String postControllerUpdateTask(@PathVariable long courseId,
	    ...
	    try {
	        ...
	        return REDIRECT_LINK + courseId + TEST_FOR_LINK + "/" + testId + TASKS_FOR_LINK;
