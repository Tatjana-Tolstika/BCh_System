...
public interface IProgramCRUDService {
	...
	public abstract void createProgram(String title, String degree, String abbreviation) throws Exception;

	public abstract StudyProgram retrieveProgramById(long id) throws Exception;

	public abstract void updateProgramById(long id, String title, String degree, String abbreviation) throws Exception;
